  ...
  [8888],
  {
    706: (e, t, n) => {
      ...
      async function O(e, t, n, r, s = {}) {
        return b(e, s, async () => {
          ...
          return (
            ...
            k.fetch()(N(e, e.config.apiHost, n, o), c)
          );
        });
      }
      ...
      async function Y(e, t) {
        let n = await b(e, {}, async () => {
          ...
          return (
            ...
            k.fetch()(a, { method: "POST", headers: o, body: n })
          );
        });
        return {
      ...
      class X {
        ...
        async refresh(e, t) {
          let { accessToken: n, refreshToken: r, expiresIn: i } = await Y(e, t);
      ...
      class et {
        ...
        async delete() {
          ...
          return (
            await $(this, V(this.auth, { idToken: e })),
      ...
      class ew {
        ...
        validatePassword(e) {
          ...
          return (
            ...
            o.isValid &&
              (o.isValid =
                null === (n = o.meetsMaxPasswordLength) || void 0 === n || n),
            o.isValid &&
              (o.isValid =
                null === (r = o.containsLowercaseLetter) || void 0 === r || r),
            o.isValid &&
              (o.isValid =
                null === (i = o.containsUppercaseLetter) || void 0 === i || i),
            o.isValid &&
              (o.isValid =
      ...
      class eT {
        ...
        _initializeWithPersistence(e, t) {
          return (
            t && (this._popupRedirectResolver = er(t)),
      ...
      class eb {
        ...
        async verify(e = "verify", t = !1) {
          ...
          return this.auth.settings.appVerificationDisabledForTesting
            ? new eP().execute("siteKey", { action: "verify" })
            : new Promise((e, i) => {
                n(this.auth)
                  .then((n) => {
      ...
      async function eN(e, t, n, r, i) {
        ...
        if (
          null === (a = e._getRecaptchaConfig()) || void 0 === a
            ? void 0
      ...
      class e$ extends eM {
        ...
        async _getIdTokenResponse(e) {
          switch (this.signInMethod) {
            ...
            case "emailLink":
              return eK(e, { email: this._email, oobCode: this._password });
            default:
              d(e, "internal-error");
          }
        }
      ...
      async function eZ(e, t) {
        ...
        if (n.temporaryProof)
          throw D(e, "account-exists-with-different-credential", n);
        return n;
      }
      let eY = { USER_NOT_FOUND: "user-not-found" };
      async function eQ(e, t) {
        return A(
          e,
          "POST",
      ...
      class eX extends eM {
        ...
        static _fromVerification(e, t) {
          return new eX({ verificationId: e, verificationCode: t });
        }
        static _fromTokenResponse(e, t) {
          return new eX({ phoneNumber: e, temporaryProof: t });
        }
        _getIdTokenResponse(e) {
      ...
      class e1 {
        ...
        static credentialWithLink(e, t) {
          ...
          return (
            _(n, "argument-error"), e$._fromEmailAndCode(e, n.code, n.tenantId)
          );
        }
      }
      (e1.PROVIDER_ID = "password"),
        (e1.EMAIL_PASSWORD_SIGN_IN_METHOD = "password"),
        (e1.EMAIL_LINK_SIGN_IN_METHOD = "emailLink");
      class e2 {
        constructor(e) {
          (this.providerId = e),
      ...
      (e6.FACEBOOK_SIGN_IN_METHOD = "facebook.com"),
        (e6.PROVIDER_ID = "facebook.com");
      class e4 extends e3 {
        constructor() {
      ...
      (e4.GOOGLE_SIGN_IN_METHOD = "google.com"),
        (e4.PROVIDER_ID = "google.com");
      class e9 extends e3 {
        constructor() {
          super("github.com");
        }
      ...
      (e9.GITHUB_SIGN_IN_METHOD = "github.com"),
        (e9.PROVIDER_ID = "github.com");
      class e8 extends e3 {
        constructor() {
          super("twitter.com");
        }
      ...
      (e8.TWITTER_SIGN_IN_METHOD = "twitter.com"),
        (e8.PROVIDER_ID = "twitter.com");
      class e5 {
        constructor(e) {
          (this.user = e.user),
      ...
      function tt(e, t, n, r) {
        return (
          ...
          if ("auth/multi-factor-auth-required" === n.code)
            throw te._fromErrorAndOperation(e, n, t, r);
          throw n;
        });
      }
      ...
      class to {
        ...
        static _fromServerResponse(e, t) {
          return "phoneInfo" in t
            ? tl._fromServerResponse(e, t)
            : "totpInfo" in t
            ? tc._fromServerResponse(e, t)
            : d(e, "internal-error");
        }
      }
      class tl extends to {
      ...
      async function tu(e, t, n) {
        ...
        _(n.handleCodeInApp, o, "argument-error"),
          n &&
            ((r = o),
            (i = l),
            _(
              (null === (a = (s = n).url) || void 0 === a ? void 0 : a.length) >
                0,
              r,
              "invalid-continue-uri"
            ),
            _(
              void 0 === s.dynamicLinkDomain || s.dynamicLinkDomain.length > 0,
              r,
              "invalid-dynamic-link-domain"
            ),
            _(
              void 0 === s.linkDomain || s.linkDomain.length > 0,
              r,
              "invalid-hosting-link-domain"
            ),
            (i.continueUrl = s.url),
            (i.dynamicLinkDomain = s.dynamicLinkDomain),
            (i.linkDomain = s.linkDomain),
            (i.canHandleCodeInApp = s.handleCodeInApp),
            s.iOS &&
              (_(s.iOS.bundleId.length > 0, r, "missing-ios-bundle-id"),
              (i.iOSBundleId = s.iOS.bundleId)),
            s.android &&
              (_(
                s.android.packageName.length > 0,
                r,
          ...
          await eN(o, l, "getOobCode", eW, "EMAIL_PASSWORD_PROVIDER");
      }
      function th(e, t) {
        let n = e0.parseLink(t);
      ...
      async function td(e, t, n) {
        ...
        return (
          _(a._tenantId === (s.tenantId || null), s, "tenant-id-mismatch"),
          ta(s, a)
        );
      }
      ...
      async function tf(e, { displayName: t, photoURL: n }) {
        ...
        let o = r.providerData.find(({ providerId: e }) => "password" === e);
        ...
        static fromJSON(e) {
          ...
          if (null == e ? void 0 : e.multiFactorSession) {
            if (
              ...
              return t_._fromMfaPendingCredential(
                e.multiFactorSession.pendingCredential
              );
            if (
              null === (n = e.multiFactorSession) || void 0 === n
                ? void 0
                : n.idToken
            )
              return t_._fromIdtoken(e.multiFactorSession.idToken);
          }
          return null;
        }
      }
            ...
            e._onReload((t) => {
              t.mfaInfo &&
                (this.enrolledFactors = t.mfaInfo.map((t) =>
                  to._fromServerResponse(e.auth, t)
                ));
            });
        }
        static _fromUser(e) {
          ...
          try {
            ...
            let e = await $(
              ...
              O(
                ...
                C(r, { idToken: n, mfaEnrollmentId: t })
              ))
            );
      ...
      function tb() {
        return (
          void 0 !== tO().WorkerGlobalScope &&
          "function" == typeof tO().importScripts
        );
      }
      async function tA() {
      ...
      function tM(e, t) {
        return e
          .transaction([tL], t ? "readwrite" : "readonly")
          .objectStore(tL);
      }
      function tF() {
        ...
        return new Promise((t, n) => {
          e.addEventListener("error", () => {
            ...
            e.addEventListener("upgradeneeded", () => {
              let t = e.result;
              try {
                t.createObjectStore(tL, { keyPath: tD });
              } catch (e) {
                n(e);
              }
            }),
            e.addEventListener("success", async () => {
              let n = e.result;
              n.objectStoreNames.contains(tL)
                ? t(n)
                : (n.close(),
                  await new tU(indexedDB.deleteDatabase(tN)).toPromise(),
                  t(await tF()));
            });
        });
      }
      async function tV(e, t, n) {
        return new tU(tM(e, !0).put({ [tD]: t, value: n })).toPromise();
      }
      ...
      class tH {
        ...
        async initializeReceiver() {
          (this.receiver = tR._getInstance(tb() ? self : null)),
        ...
        async initializeSender() {
          var e, t;
          if (
            ((this.activeServiceWorker = await tA()), !this.activeServiceWorker)
          )
            return;
        ...
        async _set(e, t) {
          return this._withPendingWrite(
            async () => (
              await this._withRetries((n) => tV(n, e, t)),
              (this.localCache[e] = t),
        ...
        async _remove(e) {
          return this._withPendingWrite(
            async () => (
              await this._withRetries((t) => tj(t, e)),
        ...
        async _poll() {
          let e = await this._withRetries((e) =>
            new tU(tM(e, !1).getAll()).toPromise()
          );
      ...
      class t1 extends tQ {
        constructor(e, t, n, r, i) {
          super(e, t, r, i),
            ...
            (this.pollId = null),
            t1.currentPopupAction && t1.currentPopupAction.cancel(),
            (t1.currentPopupAction = this);
        }
      ...
      class t3 extends tQ {
        ...
        async execute() {
          ...
          if (!e) {
            try {
              let t = (await t6(this.resolver, this.auth))
                ? await super.execute()
                : null;
              e = () => Promise.resolve(t);
            } catch (t) {
          ...
          return (
            this.bypassAuthState ||
              t2.set(this.auth._key(), () => Promise.resolve(null)),
            e()
          );
        }
        async onAuthEvent(e) {
      ...
      class nt {
        ...
        hasEventBeenHandled(e) {
          return (
            ...
            this.cachedEventUids.has(nn(e))
          );
        }
        saveEventToCache(e) {
          this.cachedEventUids.add(nn(e)),
            (this.lastProcessedEventTime = Date.now());
        }
      }
      function nn(e) {
        ...
        let t = await (nu =
            ...
            new Promise((t, n) => {
              ...
              if (
                ...
                null === (s = tO().gapi) || void 0 === s ? void 0 : s.load
              )
                o();
              else {
                let t = eR("iframefcb");
      ...
      let nI = "webStorageSupport";
      class ny {
        constructor() {
          (this.eventManagers = {}),
            (this.iframes = {}),
            (this.originValidationPromises = {}),
            (this._redirectPersistence = tk),
            (this._completeRedirectFn = t7),
            (this._overrideRedirectResult = t9);
        }
        ...
        _originValidation(e) {
          ...
          return (
            this.originValidationPromises[t] ||
              (this.originValidationPromises[t] = no(e)),
            this.originValidationPromises[t]
          );
        }
      ...
      class nE {
        constructor() {}
        static assertion(e) {
          return nT._fromCredential(e);
        }
      }
      nE.FACTOR_ID = "phone";
      class nS {
        static assertionForEnrollment(e, t) {
          return nk._fromSecret(e, t);
        }
        static assertionForSignIn(e, t) {
          return nk._fromEnrollmentId(e, t);
        }
        static async generateSecret(e) {
          ...
          let r = await O(
            ...
            C(n, { idToken: e.credential, totpEnrollmentInfo: {} })
          );
          return nR._fromStartTotpMfaEnrollmentResponse(r, e.user.auth);
        }
      }
      nS.FACTOR_ID = "totp";
      class nk extends nw {
      ...
      let nA = (0, i.XA)("authIdTokenMaxAge") || 300,
        nN = null,
        nL = (e) => async (t) => {
      ...
      function nD(e = (0, r.Sx)()) {
        ...
        let n = (function (e, t) {
          ...
          })(e, { popupRedirectResolver: ny, persistence: [tH, tS, tk] }),
        ...
        (function (e) {
          (0, r.om)(
            ...
            (0, r.om)(
              new o.uA(
                "auth-internal",
                (e) => new nb(eE(e.getProvider("auth").getImmediate())),
                "PRIVATE"
              ).setInstantiationMode("EXPLICIT")
            ),
            (0, r.KO)(
